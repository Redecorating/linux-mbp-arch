...
prepare() {
  ...
  # The patch that adds this file won't apply when this file is present.
  rm drivers/net/wireless/broadcom/brcm80211/brcmfmac/settings.h b/drivers/net/wireless/broadcom/brcm80211/brcmfmac/settings.h||:
